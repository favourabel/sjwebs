...
const skills = [
  ...
  },
  {
    ...
    icon: "☁️",
    skills: ["Vercel", "Netlify", "Render", "Railway", "Cloudinary"],
  },
];
        ...
        <div className="container mx-auto flex min-h-screen flex-col items-center justify-center gap-16 px-6 pt-32 lg:flex-row">
          ...
          <div className="z-10 flex-1">
            ...
            <p className="mt-8 max-w-xl text-lg leading-8 text-gray-400">
              ...
              the MERN stack. Passionate about clean code, problem solving and
              creating seamless digital experiences through SJ Web Solutions.
            </p>
          ...
          <div className="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mb-10 leading-8 text-gray-400">
                ...
                was founded on the 15th of May, 2026, with a vision of helping
