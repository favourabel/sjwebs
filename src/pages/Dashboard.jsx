...
// ═══════════════════════════════════════════════════════════════
//  3. SIDEBAR COMPONENT ✅ RESPONSIVE — slide-in on mobile
// ═══════════════════════════════════════════════════════════════

function Sidebar({ activeView, setActiveView, onAdd, isOpen, setIsOpen }) {
  ...
  // ✅ Close sidebar after picking a menu item (mobile only)
  ...
  return (
    <>
      {/* ✅ NEW — Mobile Backdrop (only shows when sidebar open on mobile) */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <motion.aside
        ...
        className={`fixed left-0 top-0 h-screen w-64 bg-[#0D1224] border-r border-white/5 flex flex-col z-50 transition-transform duration-300 ${
      ...
      >
        ...
        <div className="p-4 sm:p-6 border-b border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/30">
              <FiCode className="text-white text-lg" />
            </div>
            <div>
              <h2 className="text-white font-bold text-base sm:text-lg">SJ Admin</h2>
...
// ═══════════════════════════════════════════════════════════════
//  4. DASHBOARD HOME COMPONENT ✅ RESPONSIVE
// ═══════════════════════════════════════════════════════════════
        ...
        {stats.map((stat) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="relative overflow-hidden rounded-2xl bg-[#111827] border border-white/5 p-5 sm:p-6"
            >
              <div
              ...
              <div className="relative z-10">
                <div
                  className={`w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br ${stat.color} ${stat.shadow} shadow-lg flex items-center justify-center mb-3 sm:mb-4`}
                >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
          <motion.button
            ...
            className="flex items-center justify-between p-4 sm:p-5 rounded-2xl bg-[#111827] border border-white/5 hover:border-blue-500/30 transition-all group"
          >
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="text-left">
                <p className="text-white font-medium text-sm sm:text-base">View Projects</p>
                <p className="text-slate-500 text-xs sm:text-sm">Manage all your projects</p>
              </div>
            </div>
            <FiArrowRight className="text-slate-500 group-hover:text-blue-400 transition-colors flex-shrink-0 ml-2" />
          </motion.button>
          ...
          <motion.button
            ...
            className="flex items-center justify-between p-4 sm:p-5 rounded-2xl bg-[#111827] border border-white/5 hover:border-emerald-500/30 transition-all group"
          >
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="text-left">
                <p className="text-white font-medium text-sm sm:text-base">Add New Project</p>
                <p className="text-slate-500 text-xs sm:text-sm">Create a new portfolio project</p>
              </div>
            </div>
            <FiArrowRight className="text-slate-500 group-hover:text-emerald-400 transition-colors flex-shrink-0 ml-2" />
          </motion.button>
        </div>
      </motion.div>
    </div>
...
// ═══════════════════════════════════════════════════════════════
//  5. PROJECT CARD COMPONENT ✅ RESPONSIVE
// ═══════════════════════════════════════════════════════════════
    ...
    >
      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-center justify-between mb-3 gap-2">
          <span className="px-2.5 sm:px-3 py-1 text-xs font-medium text-blue-400 border border-blue-400/30 rounded-full bg-blue-400/10">
            {project.category || "Full Stack"}
          </span>
          <span className="text-slate-500 text-xs whitespace-nowrap">{project.date}</span>
        </div>

        <h3 className="text-white text-base sm:text-lg font-bold mb-2 line-clamp-1">
          {project.title}
        </h3>
        ...
        <div className="flex items-center gap-2 pt-4 border-t border-white/5">
          <motion.button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-blue-500/10 text-blue-400 text-sm font-medium hover:bg-blue-500/20 transition-colors"
          >
          ...
          <motion.button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2 rounded-xl bg-red-500/10 text-red-400 text-sm font-medium hover:bg-red-500/20 transition-colors"
          >
...
// ═══════════════════════════════════════════════════════════════
//  6. PROJECT LIST COMPONENT ✅ RESPONSIVE
// ═══════════════════════════════════════════════════════════════
  ...
  return (
    <div>
      ...
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        className="flex flex-col gap-4 mb-6 sm:mb-8 lg:flex-row lg:items-center lg:justify-between"
      >
        <div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <div className="relative w-full sm:w-auto">
            ...
            <input
              ...
              className="w-full sm:w-64 pl-10 pr-4 py-2.5 bg-[#111827] border border-white/10 rounded-xl text-white text-sm placeholder-slate-500 focus:outline-none focus:border-blue-500/50"
            />
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onAdd}
            className="flex items-center justify-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-sm font-medium rounded-xl shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-shadow whitespace-nowrap"
          >
            <FiPlusCircle />
            Add Project
          </motion.button>
      ...
      {filtered.length === 0 ? (
        ...
        >
          <HiSparkles className="text-slate-600 text-4xl sm:text-5xl mx-auto mb-4" />
          ...
          {!search && (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onAdd}
              className="px-6 py-3 bg-blue-600 text-white rounded-xl font-medium text-sm sm:text-base"
            >
...
// ═══════════════════════════════════════════════════════════════
//  7. PROJECT FORM COMPONENT ✅ RESPONSIVE
// ═══════════════════════════════════════════════════════════════
    ...
    <div>
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={onCancel}
          className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-white/10 transition-all flex-shrink-0"
        >
          <FiArrowLeft />
        </motion.button>
        <div className="min-w-0 flex-1">
        ...
        <div className="space-y-5 sm:space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#111827] border border-white/10 rounded-xl text-white text-sm sm:text-base placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-[#111827] border border-white/10 rounded-xl text-white text-sm sm:text-base placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-colors resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-[#111827] border border-white/10 rounded-xl text-white text-sm sm:text-base focus:outline-none focus:border-blue-500/50 transition-colors"
              >
                {CATEGORIES.map((cat) => (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="https://github.com/..."
                    className="w-full px-4 py-3 bg-[#111827] border border-white/10 rounded-xl text-white text-sm sm:text-base placeholder-slate-500 focus:outline-none focus:border-emerald-500/50 transition-colors"
                  />
                </div>
        ...
        <div className="space-y-5 sm:space-y-6">
          <div>
            ...
            >
              {imagePreview ? (
                ...
                <div className="h-48 sm:h-56 flex flex-col items-center justify-center gap-3 text-slate-500 px-4">
                  <FiUpload className="text-2xl sm:text-3xl" />
                  <p className="text-sm text-center">Click to upload image</p>
                  <p className="text-xs text-slate-600 text-center">JPG, PNG, WEBP (Max 5MB)</p>
                </div>
              )}
            </div>
            <input
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 bg-[#111827] border border-white/10 rounded-xl text-white text-sm sm:text-base placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-colors"
              />
              <motion.button
                type="button"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={addTech}
                className="px-4 py-3 bg-blue-500/20 text-blue-400 rounded-xl hover:bg-blue-500/30 transition-colors flex-shrink-0"
              >
                <FiPlus />
              </motion.button>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="flex-1 flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl shadow-lg shadow-blue-500/20 disabled:opacity-60 disabled:cursor-not-allowed text-sm sm:text-base"
            >
              {loading ? (
                <>
                  <motion.div
            ...
            <motion.button
              ...
              type="button"
              onClick={onCancel}
              className="px-6 py-3 bg-white/5 text-slate-400 font-medium rounded-xl hover:bg-white/10 hover:text-white transition-all text-sm sm:text-base"
            >
              Cancel
            </motion.button>
          </div>
...
// ═══════════════════════════════════════════════════════════════
//  8. MAIN DASHBOARD COMPONENT ✅ RESPONSIVE
// ═══════════════════════════════════════════════════════════════
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E] flex">
      ...
      <main className="flex-1 lg:ml-64 min-h-screen overflow-y-auto">
        ...
        <div className="lg:hidden sticky top-0 z-30 bg-[#0A0F1E]/90 backdrop-blur-md border-b border-white/5 px-4 py-3 flex items-center justify-between">
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-bold text-sm">SJ Admin</span>
          </div>
        </div>
